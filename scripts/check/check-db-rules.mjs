...
export const INTENTIONALLY_INTERNAL = new Set([
  ...
  "caseMapping", // db-internal: importado só por db/core.ts (snake↔camel column mapping puro, extraído de core.ts no #4947; core.ts re-exporta os 5 helpers p/ compat)
  ...
  "schemaColumns", // db-internal: importado só por db/core.ts (reconciliação idempotente de colunas ALTER TABLE … ADD COLUMN + introspecção, extraído de core.ts no #4947; recebe o handle explícito)
